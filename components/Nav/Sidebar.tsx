...
export default function Sidebar({
  ...
  return (
    <>
      {open && (
        <div
          className="block md:hidden fixed inset-0 bg-black/60 z-10"
          onClick={() => {
            setOpen(false);
          }}
        />
      ...
      >
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            {open && (
              <div className="mt-6">
                <p className="text-xs uppercase tracking-wide text-slate-500 px-3 py-1 mb-1">
                  Recent Chats
                </p>
                    ...
                    >
                      ...
                      {t.saved && (
                        <div
                          ...
                          className="p-1 rounded-md md:opacity-0 md:group-hover:opacity-100 hover:bg-border transition-opacity shrink-0"
                        >
